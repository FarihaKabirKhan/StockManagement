...
namespace StockManagement {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class tblCustomerDataTable : global::System.Data.TypedTableBase<tblCustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tblCustomerRow AddtblCustomerRow(string customerName, string customerAddress, string email, string phoneNumber) {
...
namespace StockManagement.CustomerDataSetTableAdapters {
    ...
    public partial class tblCustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblCustomer] WHERE (([customerID] = @Original_customerID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblCustomer] ([customerName], [customerAddress], [email], [pho" +
                "neNumber]) VALUES (@customerName, @customerAddress, @email, @phoneNumber)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblCustomer] SET [customerName] = @customerName, [customerAddress] " +
                "= @customerAddress, [email] = @email, [phoneNumber] = @phoneNumber WHERE (([cust" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT customerID, customerName, customerAddress, email, phoneNumber FROM dbo.tbl" +
                "Customer";
        ...
        public virtual int Fill(CustomerDataSet.tblCustomerDataTable dataTable) {
        ...
        public virtual CustomerDataSet.tblCustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerDataSet.tblCustomerDataTable dataTable = new CustomerDataSet.tblCustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerDataSet.tblCustomerDataTable dataTable) {
        ...
        public virtual int Insert(string customerName, string customerAddress, string email, string phoneNumber) {
        ...
        public virtual int Update(string customerName, string customerAddress, string email, string phoneNumber, int Original_customerID) {
            if ((customerName == null)) {
                throw new global::System.ArgumentNullException("customerName");
            }
            else {
